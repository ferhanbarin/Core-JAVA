...
public class C1_List_01 {
	...
	public static void main(String[] args) {
    	...
    	Not : yeter icin kucuk buyuk harf onemli degil, ancak isimler icin önemli.
    	*/
		...
		} while (!isim.equalsIgnoreCase("yeter")); // Kullanici yeter yazmadigi sürece tekrar ettim.
			
		// Karsilastirmak istedigimiz listeyi olusturalim.
		// Listenin uzunlugu degismeyeci icin Array olusturup, list'e cevirebilirim. Böylece 6 ismi tek tek eklemek zorunda kalmam.
