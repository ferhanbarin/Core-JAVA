...
public class C1_MethodCreationTraining_01 {

	public static void main(String[] args) {
		
		/*
		Soru : Bir oyun programinda oyuncuya level ve puanina gore bonus hesaplayan bir method yaziniz.
		Bonus eklendikten sonra oyuncu yeni puaniyla oyuna devam edecek. (Oyun icinde birden fazla defa bonus ekleme fonksiyonu kullanilabilir)
		Bonus kurali :
	...
	private static int bonusHesapla(int level, int puan) {
		...
		if (level <= 10) {
			...
			// 11-50 level arasi mevcut puanin yüzde 10'u kadar bonus.
			bonus = puan*10/100;
		} else {
