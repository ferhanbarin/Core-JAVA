...
public class C1_Set_01 {
	...
	Set : 1) unique(benzersiz tek) elemanlardan olusur, Set'lerin icinde bir eleman sadece bir kere kullanilabilir. mükerrer(duplicate) eleman olmaz.
		  2) sadece bir null degeri alabilir.(treeSet hariç).Java elementleri unique yapmak icin HASH ALGORITMASI kullanir.
    Java her data icin hashing teknigini kullanarak bir code uretir.Bu code'u almak icin HashCode() methodu kullanilir.
    Hashing, farkli büyüklükteki girdilerden sabit büyüklükte bir çikti olusturma sürecine verilen isimdir.
    Universitelerdeki ögrenci numaralari gibi bir ogrenci ismi soruldugunda numarasini bulursaniz onunla ilgili tum datalara ulasilabilir.
       ...
       Set     --> HashSet         : 1) HashSet, duplication’a(tekrarli eleman) izin vermez. Eger bir elemani tekrar HashSet’e eklemek isterseniz eski olan silinip, yeni olan uzerine yazilir.
                           		  2) Haset'ler Set'ler arasinda en hizli olanidir. bir algoritmaya göre kayit eder. Degerlerin giris sirasina dikkat edilmez. (LinkedHashSet hariç)
	...
	.retainAll(collection1);-->collection1’nin elemanlarinin disindaki tum elemanlari siler, silme islemi yapti ise true, yoksa false dondurur(kesisen ortak elemanlari döndürür.)
